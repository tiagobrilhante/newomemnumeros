...
CREATE TABLE `roles` (
    ...
    INDEX `roles_sectionId_idx`(`sectionId`),
    INDEX `roles_deleted_idx`(`deleted`),
    UNIQUE INDEX `roles_acronym_sectionId_key`(`acronym`, `sectionId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
-- AddForeignKey
ALTER TABLE `roles` ADD CONSTRAINT `roles_sectionId_fkey` FOREIGN KEY (`sectionId`) REFERENCES `sections`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
